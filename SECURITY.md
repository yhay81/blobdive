...
workflow sources with extended security queries. ClusterFuzzLite runs artifact
detection and nested-reference parsing on every code-changing pull request and
